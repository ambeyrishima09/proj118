...
updateCanvas() //this function will clean the canvas and update with the new sketch name to be drawn after a particular time
{
background("white");
...
function draw()
{
    ...
    {
        answer_holder = "set"; //This is to indicate that the drawn sketch is equal to the sketch.
        score = score + 1;
